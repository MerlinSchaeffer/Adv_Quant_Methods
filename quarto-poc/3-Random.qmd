...
::: {.notes}
The $t$-value is just "how many standard errors from zero" — no more mysterious than that. The three tabs make the real point: the *same* effect is not significant in the 50-person sample and clearly significant in the full one. Nothing about the world changed, only how much sampling error we were carrying. Non-significant does not mean "no effect"; it can simply mean "not enough people".
:::
