...
format:
  revealjs:
    ...
    height: 900
    slide-number: c/t
    footer: "Lecture 6 · Randomised Controlled Trials"
    incremental: false
...
2. see how **randomisation** fixes it — in one picture *and* one formula;
...
pacman::p_load( # Load several R packages using the pacman package manager
  ...
  modelsummary) # Creates tables and plots to summarise statistical models
```
...
## Why randomisation works: a fair coin
...
## Did randomisation balance the groups?
...
\node[hero] (b) [right = of a] {Randomise};
