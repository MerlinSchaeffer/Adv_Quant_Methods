...
- The red line should ideally be the same.
  + .alert[Linearity assumption doesn't perfectly hold, but seems overall OK.]
...
modelsummary(list("Poverty" = ols_2), stars = TRUE,
  coef_rename = c("colonizerFrance" = "France", "colonizerBelgium" = "Belgium",
...
.push-right[
**Step 2**: What $\hat{y}$ does our model predict for the fictional data?
