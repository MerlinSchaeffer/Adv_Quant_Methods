...
2. Make a new variable called `APAX$candy`, which randomly "gives" candy to half of the respondents. Use the `rbinom()` function to do so. Use the help function `?rbinom()` or google "R rbinom()" to learn what the function does and how it works.
`r hide("R solution -> dont' peak to early ;) !")`
```{r}
APAX <- APAX %>% mutate(
