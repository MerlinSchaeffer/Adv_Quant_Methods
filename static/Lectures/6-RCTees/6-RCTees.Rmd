...
htmlreg( # Make a nice regression table of results.
  ...
  custom.coef.names = c("Intercept (Venus control)", 
                        ...
                        "Article on integration"), file = "For-Mads.doc")
```
]
...
ggplot(data = plotdata,  aes(y = estimate, x = term)) +
  ...
  labs(title = "Causal effect of news articles", 
    ...
    caption = "Note: Resultaterne er baseret på en vægtet OLS-regression med robuste standardfejl. N = 1085, og R2= 0.012.") + 
  theme_minimal()
```
]
