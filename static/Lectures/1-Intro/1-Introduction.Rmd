...
.font200[
**Conceptual and theory-driven empirical analysis of <br><br>immigration-based ethnic diversity and stratification,<br><br> including their contentious political consequences.**
]
...
```{r, echo = FALSE, out.width='90%', fig.align='center'}
knitr::include_graphics('./../3-Random/3-Random_files/figure-html/true_ols-1.png')
```  
