...
.panel[.panel-name[Purchasing power parity]
...
- This model accounts for `r round(summary(ols)$r.squared, 2)`* 100 % more of the variation of poverty across the world, than simply using the mean as best guess $\bar{y} = `r round(mean(Dat$poverty), 2)`\%$.
]]]
