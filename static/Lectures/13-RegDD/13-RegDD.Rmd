...
.push-left[
.content-box-blue[
RDD uses .alert[rules] that create (sharp) thresholds on otherwise continuous variables.
]
...
What if we compared people who fall on either side of the threshold?
...
But what if we compared people who fall just barely on either side of the threshold?
...
.left-column[
  ...
  2. Compare only those who are legally just too young to drink (>21) to those who are bareley old enough?
]]
