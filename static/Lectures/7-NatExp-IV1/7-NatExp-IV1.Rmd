...
3. **Today's 1st research question:** Moving out of poor neighborhoods during early childhood.
...
knitr::include_graphics('https://jlegewie.com/files/joscha.jp')
```
...
$$\underbrace{\kappa_{\text{Win lottery}\rightarrow\text{Income}}}_{1624\text{ Dollar}} = \underbrace{\kappa_{\text{Support}\rightarrow\text{Moving}}}_{0.4766} \times \underbrace{\kappa_{\text{Moving}\rightarrow\text{Income}}}_{?}$$
