...
They teamed up with 5 kindergartens and had 240 kids participate in a study.

Pædagogerne *randomly* encouraged some kids to watch Sesame Street.

Some weeks later, the pædagogerne gave the kids a small test in which they had to correctly guess letters (ABC etc.)

.center[**Did the kids performance increase?**]
]

.right-column[
```{r, echo = FALSE, out.width='80%'}
knitr::include_graphics('./img/Sesame.png')
```
]
