...
2. The variable `encouraged` indicates whether a kid was randomly encouraged by its pædagog to watch Sesame Street. The variable `prelet` contains the result of the same letter-recognition test, which the pædagogerne had conducted *before* they started to 
