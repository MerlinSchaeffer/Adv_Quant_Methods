...
3. Beyond the variables observed in APAX, consider with your neighbor which unobserved other confounding variables might exist and bias our estimate of the news effect. Here are some potential unobserved confounders that could bias our estimate of the causal effect of news consumption on support for anti-discrimination policies:
  + Political ideology: People with different political ideologies may be more or less likely to read the news and to support anti-discrimination policies.
  + Social networks: People who are connected to people who read the news may be more or less likely to read the news themselves.