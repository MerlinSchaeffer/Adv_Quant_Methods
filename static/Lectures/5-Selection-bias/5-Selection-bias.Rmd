...
.right-column[
Statements by research subjects are valuable,
but they are .alert[not credible scientific evidence].

$\rightarrow$️ Many people have inaccurate perceptions 
...
```{r eval = FALSE}
load("APAX.RData") # Load APAX dataset
```

```{r results = FALSE}
APAX <- APAX %>% mutate( # Process APAX data
