...
They do not tel us the average causal effect: $Avg_{n}[Y_{1i}-Y_{0i}]$!
]
---
# Why? Selection bias!
...
.alert[Backdoor paths]: All paths linking $D$ and $Y$ that start with an arrow into $X$ `r Citep(myBib, c("pearl_causal_2016", "gerxhani_causal_2022"))`.
...
The baseline of the outcome, $Y_{0i}$, may differ between the groups we compare. This is because certain other variables (i.e. confounders) may make us select into / out of the groups.
