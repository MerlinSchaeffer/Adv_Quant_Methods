...
2. The APAX data contains a variable antidiscr_law on support for anti-discrimination policy. It asks respondents how good or bad they think it is for a country to have a law against ethnic discrimination in the workplace. The answer categories are: (1) Very bad, (2) Bad, (3) So/so, (4) Good, (5) Very good. Make a scatter plot to see whether time spent on reading news predicts more support for anti-discrimination policies. The plot should contain a 95% confidence interval for the OLS line. Make sure to use weights and to express weights as size of the scattered dots. *What does the naïv analysis suggest?*
...
3. A day has only 1440 minutes. Thus some people's answers are clearly wrong. Recode all who read news more than 4 hours to 4 hours of news consumption. Then make the plot again. *What does the naïv analysis suggest now?*
...
4. Use the binary news consumption variable and run an OLS regression. How much more or less do news readers support a law against ethnic discrimination? `r fitb(coef, width = "5")` What is the estimated standard error of this $\hat{\beta}$? `r fitb(se, width = "5")`. *What do these two statistics suggest about the naïv comparison?*
`r hide("R solution -> dont' peak too early ;) !")`
