...
1. Together with your neighbor, draw a dag of the effect of news consumption on support for anti-dsicrimination policies. Go through the APAX data and discuss which variables might be a confounder (i.e, a backdoor path). Add them to your DAG.
