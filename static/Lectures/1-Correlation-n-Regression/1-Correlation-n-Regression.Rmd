...
.left-column[
- Some of you criticized:<br><br> *But aren't socialist countries are good in providing work and equality?*
]
...
<br>
<br>
OK great, now I have two tibbles. But how can I combine them into one tibble?
]
...
.push-right[
```{r, echo = FALSE, out.width='40%'}
knitr::include_graphics('https://img.favpng.com/2/1/2/question-mark-stock-photography-clip-art-png-favpng-xX0CH6YBvYeU89gtDZMqYQQJE.jpg')
```
]
...
.push-left[
- There is no freedom-equality trade-off. 

- In fact, the z-standardized results tell us that granting more rights to citizens is associated with a stronger decline in poverty than socialism.
]
...
```{r results = 'asis'}
zols <- lm(z_poverty ~ z_socialist, Dat) # Regression models.
zols_2 <- lm(z_poverty ~ z_citizen_rights, Dat)
htmlreg(list(zols, zols_2), # Nicely-formatted table.
