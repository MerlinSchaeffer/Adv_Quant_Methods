...
For example, the average causal effect of reading the news: compares discrimination for everyone in the sample in the hypothetical scenario that they all read the news, to the discrimination for everyone in the sample in the hypothetical scenario that they did not read the news. Obviously, this can never be observed!
...
Differences in group means are (most of the time) a comparison of apples (i.e. Ferda) to oranges (i.e. Tuki).
]
