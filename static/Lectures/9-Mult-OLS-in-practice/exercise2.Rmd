...
1. Continue with our research question on the legacy of colonialism. Make a coefficient plot that visualizes the country differences (compared to Denmark as reference) before and after adjusting for the years since independence.
...
2. Visualize model predictions that show the association of years since independence (from 0 to 300 years) and extreme poverty controlled for colonializer.
`r hide("R solution -> dont' peak to early ;) !")`
