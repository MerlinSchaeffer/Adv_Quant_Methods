...
.content-box-red[
If we want to get closer to the overall average causal effect $D \rightarrow Y$, we need to control for observed confounders. *But must not control for any mediators!*
]
...
knitr::include_graphics('https://upload.wikimedia.org/wikipedia/commons/2/2d/Marx%2C_Engels%2C_Lenin%2C_Stalin..jpg')
```
]
