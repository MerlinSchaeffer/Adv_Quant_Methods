...
knitr::include_graphics('https://pbs.twimg.com/media/FciuC51WYAQIv3D?format=png&name=900x900')
```
...
summary(ols, include.ci = FALSE, digits = 3)
```
]
...
```{r}
ols_goal <- lm_robust(psppsgva ~ eduyrs, data = ESS)
